    ...
    <div class="container mt-5">
        ...
        <form method="POST" action="{{ route('coffee.store') }}" enctype="multipart/form-data" class="mt-3">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <select name="base" id="form-base" class="custom-select">
                        <option value="option1">コーヒー</option>
                        <option value="option2">エスプレッソ</option>
                        <option value="option3">ドリップ</option>
                        <!-- 追加の選択肢を必要に応じてここに追加 -->
                    </select>
                    <div class="input-group-append" style="flex: 1;">
                        <input type="text" name="custom_base" id="form-custom-base" class="form-control"
                            style="width: 300px;" placeholder="選択肢にないものはここに入力">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="file" name="image" id="form-image" class="form-control-file"
